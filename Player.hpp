...
inline int Player::getX() { return rect.x; }
inline int Player::getY() { return rect.y; }

inline void Player::setX(int x) { rect.x = x; }
inline void Player::setY(int y) { rect.y = y; }

inline int Player::getHeight() { return rect.height; }

inline int Player::getWidth() { return rect.width; }

inline void Player::setHeight(float height) { rect.height = height; }
